...
class BackgroundQueue {
    ...
    enqueue(taskType_1, data_1) {
        return __awaiter(this, arguments, void 0, function* (taskType, data, priority = 1) {
...
class BackgroundWorkers {
    ...
    static sendNotificationEmail(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
    ...
    static processMediaUpload(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
    ...
    static updateUserStats(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                console.log(`Updating user stats for ${data.userId}`);
                const client = yield mongodb_1.MongoClient.connect(MONGODB_URI);
                const db = client.db();
                yield db.collection('user_stats').updateOne({ user_id: new mongodb_1.ObjectId(data.userId) }, { $set: Object.assign(Object.assign({}, data.stats), { updated_at: new Date() }) }, { upsert: true });
                yield client.close();
    ...
    static cleanupExpiredData(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                switch (data.type) {
                    case 'stories':
                        result = yield db.collection('stories').deleteMany({
                            expires_at: { $lt: data.olderThan }
                        });
                        break;
                    case 'sessions':
                        result = yield db.collection('sessions').deleteMany({
                            expires_at: { $lt: data.olderThan }
                        });
                        break;
                    case 'temp_files':
                        result = yield db.collection('temp_files').deleteMany({
    ...
    static generateAnalyticsReport(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const likesCount = yield db.collection('likes').countDocuments({
                    user_id: new mongodb_1.ObjectId(data.userId)
                });
                ...
                yield db.collection('analytics_reports').insertOne(report);
                yield client.close();
    ...
    static backupUserData(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield db.collection('user_backups').insertOne(backup);
                yield client.close();
