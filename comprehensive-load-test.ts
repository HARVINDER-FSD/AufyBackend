...
const NUM_USERS = 30; // 30 concurrent users performing complex actions
const RAMP_UP_MS = 10000; // 10 seconds ramp up
...
async function runComprehensiveLoadTest() {
  console.log(`\n🚀 STARTING COMPREHENSIVE BACKEND LOAD TEST`);
  console.log(`===========================================`);
  ...
  if (stats.failed === 0) {
      console.log(`\n✅ PASSED: Backend handled all scenarios perfectly.`);
  } else {
      console.log(`\n⚠️  WARNING: Some requests failed. Check logs.`);
  }
}
